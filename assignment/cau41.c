...
int count(int a[][max], int rows, int cols);
...
int main(){
    ...
    printf("the number of positive values on the main diagonal in a square matrix of real numbers is %d", count(a,rows,columns));
    return 0;
}
